<?php
	...
	$movieData = $movieDB->getMovieList($start, $length, $order, (isset($filters['title']) ? $filters['title'] : ''), (isset($filters['genre']) ? $filters['genre'] : ''), (isset($filters['description']) ? $filters['description'] : ''), (isset($filters['release_date']) ? $filters['release_date'] : ''));
